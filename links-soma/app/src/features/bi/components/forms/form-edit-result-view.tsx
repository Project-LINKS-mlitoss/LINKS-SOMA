...
import { useEditViewForm, useWorkbookIdsSearchQuery } from "../../hooks";
import { ErrorMessage } from "../../../../shared/components/error-message";
import { floatToPercent } from "../../util";
      ...
      <form
        ...
        onSubmit={async (e) => {
          try {
            ...
            rendererLogger.error("Form submission failed", error, {
              formType: "edit-result-view",
            });
          }
        }}
      >

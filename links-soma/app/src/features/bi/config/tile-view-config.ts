...
export const FILTER_COLUMN_CATEGORIES: {
  ...
  building: [
    {
      name: "空き家判定",
      columns: ["predicted_probability", "predicted_label", "reference_date"],
    },
    {
      name: "基本情報",
      columns: [
...
const TABLE_FIELDS: TileViewFieldOption[] = [
  {
    ...
    option: [
      ...
      { unit: "building", value: "days_since_registration_event" },
      ...
      { unit: "building", value: "date_registration_event" },
      ...
      { unit: "building", value: "flag_inheritance" },
      { unit: "building", value: "flag_gift" },
      { unit: "building", value: "flag_sale" },
      { unit: "building", value: "flag_seizure" },

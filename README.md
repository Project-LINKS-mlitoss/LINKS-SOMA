...
### テンプレートデータについて
テンプレートのAIモデルを公開しています。
なお、テンプレートのAIモデルを活用する場合は、AIモデルに準拠したインプットデータを作成する必要があるため、インプットデータのテンプレートも併せて利用してください。

サンプルデータ・テンプレートデータは[こちら](https://github.com/Project-LINKS-mlitoss/LINKS-SOMA/tree/main/example/data)からダウンロードしてください。
